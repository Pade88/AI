hanoi = (function()
{
	...
	var nextMove = function()
	{
		if (moves.length == 0)
		{
			status.textContent = "Am terminat!";
			return;
		}

		status.textContent = moves.length + " miscari ramase";
	...
	{
		poles_mid = []
		poles_mid.push(650); // pozitii stalpi, 200 diferenta
		poles_mid.push(850);
		poles_mid.push(1050);
		poles_top = 350;
